		...
		show: function(image) {
			...
			$('#photo-comment'+photoid).submit(function(e) {			
				...
				$.ajax({ 
					...
					success: function(response){
						$('#new-comment').val('');
						$(".comments ul").append('<li><div class="profile-photo" data-src="'+user_info.profile_photo+'"></div><h3><a href="index.php?page=profile&id='+user_info.ido+'">'+user_info.first_name+'</a> <i class="mdi-image-brightness-1"></i></h3><div class="comment">'+response.comment+'</div></li>');
